<template name="yq-avatar">
	<view>
		...
		<canvas canvas-id="prv-canvas" class="prv-canvas" disable-scroll="false" @touchstart="fHideImg"
	...
	export default {
		...
		methods: {
			...
			fWindowResize() {
				...
				// #ifdef H5
				this.windowHeight += sysInfo.windowTop - this.moreHeight;
				// #endif
				// #ifndef MP
				this.windowHeight += this.moreHeight;
				// #endif
