		...
		methods: {
			...
			fWindowResize() {
				...
				if(this.platform === 'android') {
					this.windowHeight = sysInfo.screenHeight + sysInfo.statusBarHeight;//sysInfo.windowHeight + sysInfo.windowBottom + this.moreHeight + 55;
				} else {
				...
				console.log(JSON.stringify(sysInfo), tabHeight,this.windowHeight, this.cvsStyleHeight)
			...
			fPreview() {
				...
				uni.canvasToTempFilePath({
					...
					success: (r)=>{
						...
						this.prvTop = '0';
						// #endif
						console.log(this.windowHeight,this.cvsStyleHeight)
					},
					fail: ()=>{
						uni.showLoading({
							title: "error2",
